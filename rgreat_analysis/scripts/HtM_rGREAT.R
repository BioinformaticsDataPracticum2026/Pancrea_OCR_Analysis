...
# 1. Paths
# ===============================
#genome_build <- "mm10" # mouse genome for shared
genome_build <- "hg38" # human genome for not_open
...
background_file <- "/ocean/projects/bio230007p/jji5/data/Human_Pancreas_ATAC/peak/idr_reproducibility/idr.optimal_peak.narrowPeak" #for not_open, using human peaks as background since the input is human peaks that are not open in mouse
#background_file <- "/ocean/projects/bio230007p/jji5/data/Mouse_Pancreas_ATAC/peak/idr_reproducibility/idr.optimal_peak.narrowPeak" #for shared, using mouse peaks as background since the input is shared peaks that are open in both species
